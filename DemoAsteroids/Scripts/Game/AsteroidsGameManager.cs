...
namespace Photon.Pun.Demo.Asteroids
{
    public class AsteroidsGameManager : MonoBehaviourPunCallbacks
    {
        ...
        {
            PhotonNetwork.InstantiateRoomObject("Puck", new Vector3(0.0f, 5.6f, 0.0f),
                Quaternion.Euler(0.0f,0.0f,0.0f), 0);
        }
        ...
        private void StartGame()
        {
            ...
            //Vector3 position = new Vector3(x, 4.5f, z);
            if (PhotonNetwork.LocalPlayer.GetPlayerNumber() == 0)
            {
                position = new Vector3(3.5f, 3.75f, -56.67f);
            }
            else
            {
                position = new Vector3(3.5f, 3.75f, 65.32f);
            }
