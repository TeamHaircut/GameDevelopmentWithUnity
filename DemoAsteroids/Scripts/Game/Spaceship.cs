...
#pragma warning restore 0109
        ...
        public void Fire(Vector3 position, Quaternion rotation, PhotonMessageInfo info)
        {
            ...
            //bullet = Instantiate(ball, nozzle.transform.position, Quaternion.identity) as GameObject;
            ...
            Vector3 baseY = rotation * Vector3.up;
            Vector3 baseX = rotation * Vector3.forward;
            Vector3 baseZ = rotation * Vector3.forward;

            //Vector3 offsetLeft = -1.5f * baseX - 0.5f * baseZ;
            Vector3 offset = 1.01f *baseY + 15.0f * baseX + 0.0f * baseZ;
            ...
            bullet = Instantiate(BulletPrefab, rigidbody.position + offset, Quaternion.identity) as GameObject;
